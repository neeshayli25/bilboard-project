...
export default function CreateBooking() {
  ...
  const pricing = useMemo(() => {
    ...
    return {
      ...
      formula: `${formatPkr(ratePerMinute)} x ${durationMinutes} min = ${formatPkr(totalPrice)}`,
    };
                ...
                <>
                  ...
                  <div className="rounded-3xl border border-white/10 bg-[#0A0F1C]/70 p-6">
                    ...
                    <div className="mt-5 space-y-3 text-sm text-blue-100/70">
                      ...
                      <div className="rounded-2xl border border-white/10 bg-white/5 px-4 py-4">
                        3. After you pay and upload proof, the admin verifies the payment and then the booking becomes scheduled.
                      </div>
              ...
              <div className="rounded-3xl border border-white/10 bg-[#0A0F1C]/70 p-5">
                ...
                <div className="mt-4 space-y-3 text-sm text-blue-100/65">
                  <div className="flex items-center justify-between gap-4">
                    <span>Rate</span>
                    <span className="text-white">{formatPkr(billboard.pricePerMinute ?? billboard.pricePerHour)} / min</span>
                  </div>
                  <div className="flex items-center justify-between gap-4">
                    <span>Date</span>
                ...
                <div className="mt-5 rounded-2xl border border-white/10 bg-white/5 p-4">
                  <div className="flex items-center justify-between gap-4 text-base font-black text-white">
                    ...
                    <span>{pricing.valid ? formatPkr(pricing.totalPrice) : "PKR 0"}</span>
                  </div>
                  <p className="mt-2 text-xs text-blue-100/45">
                    {pricing.valid ? pricing.formula : "Example: PKR 3,000/min for 4 minutes = PKR 12,000."} The admin reviews this first. Payment appears later in My Bookings after approval.
                  </p>
                </div>
