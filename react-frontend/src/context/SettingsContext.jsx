  ...
  useEffect(() => {
    try {
      ...
      if (stored) {
        ...
        // Migration: old demos used tiny PKR/minute values such as 5 or 500.
        // Real billboard rates should start in the thousands.
        if ((Number(parsed.minBookingPKR) || 0) < Number(DEFAULT_SETTINGS.minBookingPKR)) {
