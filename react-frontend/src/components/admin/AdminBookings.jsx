...
export default function AdminBookings() {
  ...
  const handleCancelUnpaidBooking = async (bookingId) => {
    if (!window.confirm("Cancel this approved unpaid booking? The advertiser will no longer be able to pay for this request.")) return;

    await performAction(
      bookingId,
      () => updateBookingStatus(bookingId, "cancelled"),
      "Unpaid booking cancelled. The slot is available again."
    );
  };
